...
#Sequential Search: Sequential search means to search through an entire list (array), starting at the first record/row and looking through every one until the last, when looking for something. 
...
#we are utilizing binary-1.txt for this demo
...
with open("week6demosAndNotes/binary-1.txt") as csvfile:
    ...
    for rec in file:
        ...
        #print(rec)
        records += 1        #keeps track of the number of records in the file/each list
...
while answer == "y":
    ...
    #gather each item data -- NECESSARY
